...
public class ArrayUtilities {
	 ...
	 * @param cellWidth
	 */
	public static void printDoubleDimensionalArray(int[][] array,int cellWidth) {
		for (int i = 0; i < array.length; i++) {
			for (int j = 0; j < array[0].length; j++) {
				String string = String.valueOf(array[i][j]);
				System.out.print(string);
	 ...
	 * [0,0] appears on bottom
	 */
	public static void printDoubleDimensionalArrayNeatly(int[][] array,int cellWidth) {
		for (int i = array.length-1; i >= 0; i--) {
			for (int j = 0; j < array[0].length; j++) {
				String string = String.valueOf(array[i][j]);
				System.out.print(string);
	 ...
	 * @param cellWidth
	 */
	public static void printDoubleDimensionalArray(char[][] array,int cellWidth) {
		for (int i = 0; i < array.length; i++) {
			for (int j = 0; j < array[0].length; j++) {
				String string = String.valueOf(array[i][j]);
				System.out.print(string);
	 ...
	 * [0,0] appears on bottom
	 */
	public static void printDoubleDimensionalArrayNeatly(char[][] array,int cellWidth) {
		for (int i = array.length-1; i >= 0; i--) {
			for (int j = 0; j < array[0].length; j++) {
				String string = String.valueOf(array[i][j]);
				System.out.print(string);
