...
public class BinaryTreeUtils {
	...
	public static Node populateTree(String testFile,BinaryTreeNoParent tree) {
	...
	public static Node populateTree(File testFile,BinaryTreeNoParent tree) {
		Node root = null;
